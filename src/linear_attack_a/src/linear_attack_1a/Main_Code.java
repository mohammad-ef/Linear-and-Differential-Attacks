				...
				for(int r3=0;r3<16;r3++) {
					...
					for(int r4=0;r4<16;r4++) {
						...
						if(active_s) {
							...
							bias_r1[2]=-1;
							bias_r1[3]=-1;
							continue;//route filtering based on line 126
						}
							
						
		//round 2				///////////////////////////////////////////////////////////////////////////////
						// round Permutation calculation. till line 180
				for(int k=0;k<4;k++) 
						...
						if(Math.abs(top_bias_6[min_index])<Math.abs(bias)) {//obtain lowest bias of top 6
					       ...
					       p=0;
							...
							for(int t=0; t<4;t++) {
								...
								/*System.out.println();
								for(int i=0;i<4;i++) 
									System.out.print(" sbox"+(i+1)+"_bias:"+bias_r3[i]);
								System.out.print("  Piling-Up r2>>"+bias3);
								System.out.println();*/
